...
abstract class Fabriq {
  ...
  public static function siteTitle() {
      return Fabriq\Core\Config::get('title');
  }
...
class BaseMapping {
  ...
  public static function getUrl() {
    return Fabriq\Core\Config::get('url') . Fabriq\Core\Config::get('apppath');
  }
  ...
  public static function base_path() {
    return Fabriq\Core\Config::get('apppath');
  }
  ...
  public static function clean_urls() {
    return Fabriq\Core\Config::get('cleanurls');
  }
  ...
  public static function clean_urls_str() {
    if (Fabriq\Core\Config::get('cleanurls')) {
      return 'true';
    }
    return 'false';
  }
    ...
    if (count($q) > 0) {
      ...
      if (count($q) > 1) {
        if (!is_numeric($q[1])) {
          ...
          $action = Fabriq\Core\Config::get('adefault');
        }
      } else {
        $action = Fabriq\Core\Config::get('adefault');
      }
...
abstract class FabriqTemplates {
  ...
  public static function init() {
    if (!isset(Fabriq\Core\Config::get('templates')['default'])) {
      Fabriq\Core\Config::get('templates')['default'] = 'application';
    }
    if (trim(FabriqTemplates::template() == '')) {
      FabriqTemplates::template(Fabriq\Core\Config::get('templates')['default']);
    }
  }
